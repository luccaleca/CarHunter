...
class _CarroWidgetState extends State<CarroWidget> {
  ...
  Widget buildLogo() {
    if (widget.site.contains('webmotors')) {
      // logo da Webmotors
      return Image.asset('assets/logo_webm.png',
          width: 50,
          height: 50); // Substitua pelo caminho do seu logo da Webmotors
    } else if (widget.site.contains('olx')) {
      // logo da OLX
      return Image.asset('assets/logo_olx.png',
          width: 50, height: 50); // Substitua pelo caminho do seu logo da OLX
    } else if (widget.site.contains('icarros')) {
      // logo da iCarros
      return Image.asset('assets/logo_icarros.png',
          width: 50,
          height: 50); // Substitua pelo caminho do seu logo da iCarros
    } else if (widget.site.contains('mercadolivre')) {
      // logo Mercado livre
      return Image.asset('assets/logo_mercado.png',
          width: 50, height: 50); // Substitua pelo caminho do seu logo padrão
    } else {
                      ...
                      children: [
                        ...
                        Text(widget.precoM,
                            style: const TextStyle(
                                ...
                                color: Color.fromARGB(255, 30, 30, 30))),
                        const SizedBox(height: 2),
                        Text('FIPE: ' + widget.fipe,
                            style: const TextStyle(
                                fontSize: 10,
                                color: Color.fromARGB(130, 30, 30, 30))),
                        const SizedBox(height: 2),
                        Text(
                            widget.cor +
                                ' ' +
                    ...
                    Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          style: ButtonStyle(
                            minimumSize:
                                MaterialStateProperty.all(Size(15, 30)),
                            backgroundColor: MaterialStateProperty.all<Color>(
                                const Color.fromARGB(255, 15, 59, 80)),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        //nome = Modelo + Marca
                        const SizedBox(height: 4),
                        Text(widget.modelo + ' ' + widget.marca,
                            style: const TextStyle(
                                fontSize: 17,
                                color: Color.fromARGB(255, 30, 30, 30))),
                        const SizedBox(height: 2),
                      ...
                      children: [
                        ...
                        Text(widget.cor,
                            style: const TextStyle(
                                ...
                                color: Color.fromARGB(130, 30, 30, 30))),
                        const SizedBox(height: 2),
                        Text(widget.carroceria,
                            style: const TextStyle(
                                fontSize: 15,
                                color: Color.fromARGB(130, 30, 30, 30))),
                        const SizedBox(height: 2),
                        Text(widget.condicao,
                            style: const TextStyle(
                                fontSize: 15,
                                color: Color.fromARGB(130, 30, 30, 30)))
                      ],
